...
export default function Login({handlePage}) {
  const [fields, handleChange] = useFormFields({ username: "", password: "",email:'' });
  ...
  return (
    <div className="min-h-screen flex flex-col gap-3 items-center justify-center bg-gradient-to-br to-purple-100 p-4">
      ...
      <form
        ...
        className="flex flex-col justify-center gap-5 max-w-sm p-6 w-[400px] h-120 bg-gradient-to-br from-indigo-100 to-purple-80 shadow-md rounded-lg space-y-4">
